...
function updateRotation(yaw, pitch, roll) {
...
async function fetchAndUpdateRotationData() {
    try {
        const response = await fetch('http://192.168.178.77:8088/maschinendaten');
...
// Aufrufen der Funktion, um die Daten zu laden und anzuzeigen
fetchAndUpdateRotationData();
